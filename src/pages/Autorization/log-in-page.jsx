  ...
  if (forgotPassword) {
    return (
      <ForgotPasswordPage
        ...
        onLoginClick={() => setForgotPassword(false)}
      />
    );
  }
      ...
      <div className="p-10 w-[auto] h-auto max-w-lg mx-auto bg-gray-50 mb-28">
        ...
        >
          ...
          <div className="mb-6 relative">
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 border rounded pr-10 ${
                  errors.password && !forgotPassword ? "border-red-500" : ""
                }`}
                placeholder="Пароль"
                {...register("password", {
            ...
            <a
              href="#"
              className="absolute right-0 top-1/2 transform -translate-y-1/2 text-sm mt-9 text-purple-700 hover:underline"
          ...
          <div className="text-center mb-6">
            <button
              className={`w-[300px] rounded px-4 py-2 text-white text-lg mt-6 font-medium transition duration-150 ease-in-out ${
